<script>
	import Constanta from '../../static/constanta.jpg';
</script>

<div class="w-full py-8 px-8 lg:px-24 xl:px-48 text-white font-mukta">
	<h1 class="text-3xl text-center">Despre Malcons-Com</h1>
	<div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 my-4">
		<div>
			<h2 class="text-xl">Constructii civile si industriale</h2>
			<p class="pt-4">
		...
		<div>
			<img src={Constanta} alt="Constanta" class="shadow-2xl rounded-xl" />
		</div>
	</div>
</div>
